...
# compile emacs
yay -S gtk3 libxft libxpm libtiff giflib tree-sitter
git clone git://git.sv.gnu.org/emacs.git
cd emacs
./autogen.sh
./configure --with-json --with-xinput2 --with-x-toolkit=gtk3 --without-compress-install --with-tree-sitter
make
sudo make install
#+end_src
...
#+begin_src sh
# required
yay -S picom dunst network-manager-applet pasystray udiskie blueman feh brightnessctl alsa-utils playerctl scrot fcitx5-rime fcitx5-im fcitx5-skin-adwaita-dark rofi
# optional
...
# misc
yay -S firefox kitty aspell aspell-en
#+end_src
