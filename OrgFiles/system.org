...
#+begin_src sh
# core
yay -S gdm gnome-shell gnome-control-center gnome-keyring gnome-tweaks
sudo systemctl enable gdm.service -f
# extra
yay -S gnome-themes-extra gnome-shell-extension-dash-to-dock gnome-shell-extension-blur-my-shell gnome-shell-extension-appindicator gnome-shell-extension-hide-universal-access iio-sensor-proxy xcursor-breeze ibus-rime nautilus loupe gnome-logs gnome-disk-utility impression
# keyd
yay -S keyd
...
gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'firefox.desktop', 'kitty.desktop', 'org.gnome.Logs.desktop', 'org.gnome.DiskUtility.desktop', 'emacs.desktop', 'libreoffice-startcenter.desktop', 'mpv.desktop', 'com.obsproject.Studio.desktop', 'io.gitlab.adhami3310.Impression.desktop', 'Zoom.desktop']"
# blur my shell
