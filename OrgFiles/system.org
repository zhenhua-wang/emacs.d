...
*** install
#+begin_src sh
yay -S gdm gnome-shell gnome-control-center gnome-keyring gnome-tweaks gnome-shell-extension-dash-to-dock gnome-shell-extension-blur-my-shell gnome-shell-extension-appindicator gnome-shell-extension-hide-universal-access eog ibus-rime iio-sensor-proxy nautilus gnome-themes-extra xcursor-breeze
...
yay -S firefox kitty htop neofetch obs-studio mpv yt-dlp streamlink file-roller libreoffice-still thunar tumbler ffmpegthumbnailer
