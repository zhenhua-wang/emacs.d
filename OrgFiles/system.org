...
## r
mamba install conda-forge::r-base r::r-tidyverse conda-forge::r-sf conda-forge::r-spdep
## python
mamba install numpy scipy matplotlib scikit-learn pytorch torchvision torchaudio cpuonly -c pytorch
#+end_src
