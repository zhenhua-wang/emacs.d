...
# extra
yay -S gnome-themes-extra gnome-shell-extension-dash-to-dock gnome-shell-extension-blur-my-shell gnome-shell-extension-appindicator gnome-shell-extension-hide-universal-access iio-sensor-proxy xcursor-breeze ibus-rime nautilus loupe gnome-logs snapshot
# keyd
yay -S keyd
...
gsettings set org.gnome.shell favorite-apps "'org.gnome.Nautilus.desktop', 'firefox.desktop', 'kitty.desktop', 'org.gnome.Snapshot.desktop', 'org.gnome.Logs.desktop', 'mpv.desktop', 'Zoom.desktop', 'com.obsproject.Studio.desktop', 'libreoffice-startcenter.desktop', 'emacs.desktop'"
# blur my shell
