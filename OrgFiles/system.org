...
# extra
yay -S gnome-themes-extra gnome-shell-extension-dash-to-dock gnome-shell-extension-blur-my-shell gnome-shell-extension-appindicator gnome-shell-extension-hide-universal-access iio-sensor-proxy xcursor-breeze ibus-rime nautilus loupe gnome-logs gnome-disk-utility baobab impression
# keyd
yay -S keyd
