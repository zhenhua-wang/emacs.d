...
modules-left = powermenu sep emacs-buffer-path
modules-center = corner-left date corner-right
modules-right = emacs-keycast-key sep emacs-keycast-desc sep-long battery
separator = ""
