...
font-0 = "Noto Sans Mono:style=Regular:size=10;4pt"
font-1 = "Noto Sans Mono CJK SC:style=Regular:size=10;4pt"
font-2 = "JetBrainsMono Nerd Font:style=Regular:size=10;4pt"

module-margin-left = 0
module-margin-right = 0
modules-left = powermenu emacs-buffer-path
modules-center = date
modules-right = emacs-keycast-key emacs-keycast-desc sep battery
separator = " "
