...
type = custom/ipc
hook-0 = emacsclient -e "(zw/exwm-polybar-buffer-path)" | tr -d '"'
initial = 1
format-foreground = ${colors.highlight-bg}

[module/emacs-keycast-key]
type = custom/ipc
hook-0 = emacsclient -e "(zw/exwm-polybar-keycast-key)" | tr -d '"'
initial = 1
format = <output>
...
type = custom/ipc
hook-0 = emacsclient -e "(zw/exwm-polybar-keycast-desc)" | tr -d '"'
initial = 1
format-foreground = ${colors.highlight-bg}
