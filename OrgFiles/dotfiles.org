...
* XKB
** Keyboard
#+HEADER: :tangle (zw/org-babel-tangle-linux "/etc/X11/xorg.conf.d/00-keyboard.conf")
#+begin_src conf
Section "InputClass"
...
#+HEADER: :tangle (zw/org-babel-tangle-linux "/etc/X11/xorg.conf.d/90-custom-kbd.conf")
#+begin_src conf
Section "InputClass"
    Identifier "BY Tech Air75"
...
# fade-exclude = ["class_g != 'Rofi' && class_g != 'Dunst'"];
# opacity-rule = [
