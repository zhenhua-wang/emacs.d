(custom-set-variables
 ...
 '(package-selected-packages
   '(grip-mode spacegray-theme neotree org-appear org-superstar use-package spinner rainbow-delimiters python-mode popup poly-R pfuture org-preview-html org-bullets ob-ipython magit latex-preview-pane julia-mode ivy-prescient hydra ht gruvbox-theme fish-completion ess eshell-syntax-highlighting eshell-git-prompt esh-autosuggest ein doom-themes doom-modeline dired-single dired-ranger dired-rainbow dired-collapse counsel company-prescient company-jedi company-box command-log-mode cfrs bui async all-the-icons-ivy-rich all-the-icons-ivy all-the-icons-ibuffer all-the-icons-dired ace-window)))
(custom-set-faces
