...
Exec=emacs -Q --eval '(progn (global-set-key (kbd "s-q") (quote kill-emacs)) (set-frame-width nil 80) (set-frame-height nil 35))' %F
Icon=emacs
Type=Application
Terminal=false
...
map cmd+shift+f launch --stdin-source=@screen_scrollback /usr/bin/fzf --no-sort --no-mouse --exact -i --tac
...
<Ctrl><Super>n,nautilus,nautilus,
#+end_src
