...
To use, tangle this to ~(zw/org-babel-tangle-linux "/sudo::/etc/X11/xorg.conf.d/00-keyboard.conf")~
...
Exec=/usr/bin/xremap .emacs.d/resources/scripts/keymap.yml --watch=device
Terminal=false
#+end_src
