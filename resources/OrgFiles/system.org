...
## r
conda install conda-forge::r-base conda-forge::r-tidyverse conda-forge::r-sf conda-forge::r-spdep conda-forge::r-languageserver conda-forge::r-tidybayes conda-forge::r-rstan conda-forge::r-devtools
## python
pip install numpy scipy pandas matplotlib seaborn scikit-learn jupytext ipython tqdm pyright
#+end_src
