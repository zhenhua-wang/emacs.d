...
# fonts
yay -S --noconfirm noto-fonts noto-fonts-cjk noto-fonts-emoji

# emacs
mv ~/emacs.d ~/.emacs.d
yay -S --noconfirm emacs-nativecomp emacs-lsp-booster aspell aspell-en
...
# zsh
yay -S --noconfirm zsh zsh-syntax-highlighting zsh-autosuggestions && chsh -s $(which zsh)
...
# essential desktop
yay -S --noconfirm kitty fzf htop fastfetch ripgrep mpv yt-dlp streamlink file-roller exfat-utils

# research
yay -S --noconfirm pandoc-cli texlive-basic texlive-latexextra texlive-fontsrecommended texlive-binextra texlive-mathscience texlive-plaingeneric texlive-bibtexextra miniconda3
