...
# gnome extra
yay -S gnome-themes-extra gnome-shell-extension-caffeine gnome-shell-extension-vitals baobab ibus-rime rime-ice-git gnome-weather gnome-shell-extension-weather-oclock sushi rygel gnome-user-share gnome-calendar gnome-characters gnome-connections gnome-font-viewer gnome-software loupe snapshot gnome-text-editor
# gnome experiment
