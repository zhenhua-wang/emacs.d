...
gsettings set org.gnome.shell favorite-apps "['firefox.desktop', 'org.gnome.Nautilus.desktop', 'org.gnome.DiskUtility.desktop', 'org.gnome.baobab.desktop', 'app.drey.Warp.desktop', 'io.gitlab.adhami3310.Impression.desktop', 'com.obsproject.Studio.desktop', 'de.haeckerfelix.Fragments.desktop', 'io.github.mrvladus.List.desktop', 'com.github.johnfactotum.Foliate.desktop', 'com.github.finefindus.eyedropper.desktop', 'org.gnome.SystemMonitor.desktop', 'org.gimp.GIMP.desktop']"
# window
