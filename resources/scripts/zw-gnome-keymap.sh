...
gsettings set org.gnome.desktop.wm.keybindings move-to-center "['<Shift><Super>c']"
...
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-left "['<Control><Shift><Super>bracketleft']"
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-right "['<Control><Shift><Super>bracketright']"
...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-left "['<Control><Super>bracketleft']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-right "['<Control><Super>bracketright']"
