...
(custom-set-variables
 ...
 '(package-selected-packages
   '(minions esh-autosuggest helm-fish-completion eshell-syntax-highlighting company-prescient ivy-prescient eshell-git-prompt all-the-icons-ibuffer all-the-icons-ivy-rich all-the-icons-ivy all-the-icons-dired magit company-box python-mode command-log-mode doom-themes ivy-rich rainbow-delimiters counsel company-jedi org-preview-html ob-ipython gruvbox-theme org-bullets neotree doom-modeline latex-preview-pane ein grip-mode company ess julia-mode ## poly-R))
