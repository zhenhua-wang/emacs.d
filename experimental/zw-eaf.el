...
(use-package eaf-browser
  ...
  ;; keymaps
  (defun zw/eaf-kill-line ()
    (interactive)
    (eaf-call-async "send_key_sequence" eaf--buffer-id "S-<home>")
    (eaf-call-async "send_key_sequence" eaf--buffer-id "C-<backspace>"))
  ...
  (eaf-bind-key zw/eaf-kill-line "s-<backspace>" eaf-browser-keybinding)
