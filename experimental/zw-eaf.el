...
(use-package eaf-browser
  ...
  (defun eaf-send-home ()
    (interactive)
    (eaf-call-async "send_key" eaf--buffer-id "<home>"))
  (defun eaf-send-end ()
    (interactive)
    (eaf-call-async "send_key" eaf--buffer-id "<end>"))
  (eaf-bind-key eaf-send-home "C-a" eaf-browser-keybinding)
  (eaf-bind-key eaf-send-end "C-e" eaf-browser-keybinding)
