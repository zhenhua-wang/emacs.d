...
*** Flymake
#+begin_src emacs-lisp
(bind-keys ("M-n" . flymake-goto-next-error)
...
(use-package writeroom-mode
  ...
  (writeroom-mode-enable . (lambda ()
                             (tab-bar-mode 0) (pdf-view-fit-page-to-window)))
  (writeroom-mode-disable . (lambda ()
                              (tab-bar-mode 1) (pdf-view-fit-page-to-window)))
