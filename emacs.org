...
(defun zw/modeline-theme ()
  ...
  (set-face-attribute 'mode-line          nil :box nil :font zw/default-font)
  (set-face-attribute 'mode-line-active   nil :box nil :font zw/default-font)
  (set-face-attribute 'mode-line-inactive nil :box nil :font zw/default-font))
