...
(global-set-key (kbd "s-t") 'zw/split-window-sensibly-prefer-horizontal)
...
(use-package corfu
  ...
  (defun zw/corfu-theme ()
    ...
    (set-face-attribute 'corfu-current nil
                        ...
                        :background (zw/get-face-bg-recur 'corfu-default)
                        :bold t
                        :underline (zw/get-face-bg-recur 'corfu-default))
    (with-eval-after-load 'doom-modeline
