...
(use-package lsp-ui
  ...
  ;; restart workspace when conda env changed
  (defun zw/lsp-restart-workspace ()
    (if lsp-mode
        (lsp-restart-workspace)))
  (advice-add #'conda-env-activate :after #'zw/lsp-restart-workspace)
  (advice-add #'conda-env-deactivate :after #'zw/lsp-restart-workspace))
