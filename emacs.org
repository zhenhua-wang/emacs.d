...
(use-package vterm
  ...
  (set-face-attribute 'vterm-color-blue nil :foreground "#396EB0" :background "#396EB0")
  (set-face-attribute 'vterm-color-magenta nil :foreground "#FF869E" :background "#FF869E")
  (set-face-attribute 'vterm-color-cyan nil :foreground "#32C1CD" :background "#32C1CD")
