...
(use-package mini-frame
  ...
  (setq mini-frame-advice-functions '(read-from-minibuffer)
        mini-frame-ignore-functions '(y-or-n-p yes-or-no-p))
  :config
  ;; set show parameters
  (defun zw/mini-frame-params (&rest arg)
    ...
    (set-face-background 'child-frame-border (face-background 'mode-line)))
  (advice-add #'mini-frame--display :before #'zw/mini-frame-params))
#+end_src
