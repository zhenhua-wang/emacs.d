...
(use-package vterm
  ...
  (set-face-attribute 'vterm-color-red nil :foreground "#BF616A" :background "#BF616A")
  (set-face-attribute 'vterm-color-green nil :foreground "#A3BE8C" :background "#A3BE8C")
  (set-face-attribute 'vterm-color-yellow nil :foreground "#EBCB8B" :background "#EBCB8B")
  (set-face-attribute 'vterm-color-blue nil :foreground "#5E81AC" :background "#5E81AC")
  (set-face-attribute 'vterm-color-magenta nil :foreground "#B48EAD" :background "#B48EAD")
  (set-face-attribute 'vterm-color-cyan nil :foreground "#88C0D0" :background "#88C0D0")
