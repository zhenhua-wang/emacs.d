          ...
          (lambda ()
            ...
            (setq buffer-face-mode-face
                  (list ':family zw/font-variable-pitch
                        ':height (+ zw/font-size-variable-pitch 30)))
            (buffer-face-mode)
...
(use-package company-posframe
  :straight '(company-posframe :host github :repo "zhenhua-wang/company-posframe")
  :hook
...
;; disable auto complete for the following
(dolist (mode '(inferior-ess-r-mode-hook))
  (add-hook mode
            (lambda ()
