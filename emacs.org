...
(use-package keycast
  ...
  :init (setq keycast-tab-bar-location 'tab-bar-format-tabs))
#+end_src
...
(use-package writeroom-mode
  ...
  (defun zw-disable-tab-bar-writeroom (arg)
    (cond
     ((= arg 1)
      (tab-bar-mode 0))
     ((= arg -1)
      (tab-bar-mode 1))))
  (add-to-list 'writeroom-global-effects 'zw-disable-tab-bar-writeroom))
#+end_src
