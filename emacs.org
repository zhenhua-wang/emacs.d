...
(use-package diff-hl
  ...
  :hook ((after-init . global-diff-hl-mode)
         ...
         (diff-hl-dired-mode . zw/set-diff-face))
  :init (setq diff-hl-draw-borders nil
              diff-hl-side 'left)
  :config
  (defun zw/set-diff-face ()
    (set-face-foreground 'diff-hl-dired-ignored (face-foreground 'error))
    (set-face-foreground 'diff-hl-dired-unknown (face-foreground 'error)))
