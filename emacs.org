...
(use-package company-box
  ...
  :config
  ;; set company box frame
  (defun zw/set-company-box-frame (string on-update)
    (set-frame-parameter (company-box--get-frame)
                         'tab-bar-lines 0)
    (set-frame-parameter (company-box--get-frame)
                         'tab-bar-lines-keep-state 0))
  (advice-add #'company-box--display
              :after #'zw/set-company-box-frame)
  ;; set company box doc frame
  (defun zw/set-company-box-doc-frame (selection frame)
    (set-frame-parameter (frame-local-getq company-box-doc-frame)
                         'tab-bar-lines 0)
    (set-frame-parameter (frame-local-getq company-box-doc-frame)
                         'tab-bar-lines-keep-state 0))
  (advice-add #'company-box-doc--show
              :after #'zw/set-company-box-doc-frame))
...
(use-package company-posframe
  ...
  :bind ((:map company-posframe-active-map
               ("M-d" . company-posframe-quickhelp-toggle)
