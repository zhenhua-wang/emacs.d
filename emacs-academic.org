...
;; FIXME: org-visual-indent is better
(use-package org-bars
  :disabled
  :straight `(org-bars :host github :repo "tonyaldon/org-bars")
  :hook (org-mode . org-bars-mode)
  :config (setq org-bars-extra-pixels-height 6))
...
;; FIXME: this package does not work
(use-package org-dynamic-bullets
  :disabled
  :straight `(org-dynamic-bullets
              :host github
              :repo "legalnonsense/org-visual-outline")
  :hook (org-mode . org-dynamic-bullets-mode)
  :config
  (setq org-dynamic-bullets-folded-body-text-bullet "▶"
