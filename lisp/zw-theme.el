...
(defun zw/set-theme (theme-params)
  (let* ((base-font-color     (face-foreground 'default nil 'default))
    ...
    (custom-theme-set-faces
     ...
     `(org-level-4 ((t (,@headline ,@variable-font :weight SemiBold :height 1.25))))
     `(org-level-3 ((t (,@headline ,@variable-font :weight SemiBold :height 1.25))))
     `(org-level-2 ((t (,@headline ,@variable-font :weight SemiBold :height 1.25))))
     `(org-level-1 ((t (,@headline ,@variable-font :weight SemiBold :height 1.5))))
     `(org-document-title ((t (,@headline ,@variable-font :height 1.625 :underline t))))
     ...
     `(markdown-header-face-4 ((t (,@headline ,@variable-font))))
     `(markdown-header-face-3 ((t (,@headline ,@variable-font :height 1.25))))
